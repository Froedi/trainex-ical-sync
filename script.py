...
def download_ical():
    with sync_playwright() as p:
        ...
        # Login
        page.goto(LOGIN_URL)
        page.wait_for_selector("#Login", timeout=60000)  # 60 Sekunden warten

        page.fill("#Login", USERNAME)
        page.fill("#Passwort", PASSWORD)
        page.click("#btnanm")
        page.wait_for_load_state("networkidle")  # warten bis die Seite geladen ist
        ...
        with page.expect_download() as download_info:
            page.click("text=iCal")  # klickt den iCal-Link
